<template>
    <div class="flex justify-start items-center text-gray-500">
        <a v-if="hasGithub" class="block flex items-center hover:text-gray-700 mr-6" :href="$themeConfig.github">
        ...
        <a v-if="hasTwitter" class="block flex items-center hover:text-gray-700 mr-6" :href="$themeConfig.twitter">
...
export default {
    computed:{
        ...
        hasTwitter(){
            return !!this.$themeConfig.twitter
        }
    }
}
</script>